...
let
  ...
  apps = [
    ...
    { name = "Internal Apps"; subdomain = "internal-apps"; port = 4321; icon = "mdi-application-braces"; description = "Elixir/Phoenix internal apps"; group = "Development"; protect = true; }
